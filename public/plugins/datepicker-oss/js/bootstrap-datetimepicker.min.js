  ...
  var n = function (n, a) {
    var r,
          ...
          a.sideBySide && S() && M()
            ...
            : ("top" === a.toolbarPlacement && i.append(o),
              S() &&
                i.append(
                  e("<li>")
                    .addClass(a.collapse && M() ? "collapse in" : "")
                    .append(n),
                ),
      ...
      se = function (e) {
        ...
        for (t in a.keyBinds)
          if (
            ...
            ((r = t.split(" ")),
            r.length === s.length && k[l] === r[r.length - 1])
          ) {
      ...
      fe = function () {
        ...
        (d = e.replace(
          ...
          (l = a.extraFormats ? a.extraFormats.slice() : []),
          l.indexOf(e) < 0 && l.indexOf(d) < 0 && l.push(d),
          (s =
    ...
    if (
      ...
      (c.viewMode = function (e) {
        ...
        return (a.viewMode = e), (p = Math.max(g.indexOf(e), m)), j(), c;
      }),
      ...
      o = n;
    else if (((o = n.find(a.datepickerInput)), 0 === o.length))
      o = n.find("input");
    else if (!o.is("input"))
      throw new Error(
        'CSS class "' +
