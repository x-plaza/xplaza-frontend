  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Cliquez ou appuyez sur la touche Entrée ou la barre d'espace pour ouvrir le calendrier",
      ...
      era_names: ["avant Jésus-Christ", "après Jésus-Christ"],
      era_names_abbreviated: ["av. J.-C.", "ap. J.-C."],
      era_names_narrow: ["av. J.-C.", "ap. J.-C."],
