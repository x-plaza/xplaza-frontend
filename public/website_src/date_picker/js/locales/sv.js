  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klicka eller tryck på Enter eller mellanslagstangenten för att öppna kalendern",
      ...
      day_names_abbreviated: ["sön", "mån", "tis", "ons", "tors", "fre", "lör"],
      day_names_short: ["sö", "må", "ti", "on", "to", "fr", "lö"],
      ...
      era_names: ["före Kristus", "efter Kristus"],
      era_names_abbreviated: ["f.Kr.", "e.Kr."],
      era_names_narrow: ["f.Kr.", "e.Kr."],
