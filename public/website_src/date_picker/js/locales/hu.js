  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Kattintson vagy nyomja meg az Enter billentyűt, vagy a szóközt, hogy nyissa ki a naptárt",
      ...
      day_names_abbreviated: ["V", "H", "K", "Sze", "Cs", "P", "Szo"],
      day_names_short: ["V", "H", "K", "Sze", "Cs", "P", "Szo"],
      day_names_narrow: ["V", "H", "K", "Sz", "Cs", "P", "Sz"],
      day_periods: {
        am: "de.",
        noon: "dél",
        pm: "du.",
      ...
      quarter_names_abbreviated: ["N1", "N2", "N3", "N4"],
      quarter_names_narrow: ["1.", "2.", "3.", "4."],
      era_names: ["időszámításunk előtt", "időszámításunk szerint"],
      era_names_abbreviated: ["i. e.", "i. sz."],
      era_names_narrow: ["ie.", "isz."],
