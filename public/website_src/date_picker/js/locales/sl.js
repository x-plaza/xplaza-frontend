  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Kliknite ali pritisnite tipko Enter ali preslednico, da odprete koledar",
      ...
      day_names_narrow: ["n", "p", "t", "s", "č", "p", "s"],
      day_periods: {
        am: "dop.",
        noon: "poldne",
        pm: "pop.",
      ...
      era_names: ["pred našim štetjem", "naše štetje"],
      era_names_abbreviated: ["pr. n. št.", "po Kr."],
      era_names_narrow: ["pr. n. št.", "po Kr."],
