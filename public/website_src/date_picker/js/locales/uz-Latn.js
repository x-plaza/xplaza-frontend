  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Bosing yoki Enter tugmasini bosing, yoki bo'sh satriga taqvim ochish uchun",
      ...
      day_names_short: ["Yaksh", "Dush", "Sesh", "Chor", "Pay", "Jum", "Shan"],
      day_names_narrow: ["Y", "D", "S", "C", "P", "J", "S"],
      day_periods: {
        am: "TO",
        noon: "tush payti",
        pm: "TK",
      ...
      quarter_names: ["1-chorak", "2-chorak", "3-chorak", "4-chorak"],
      quarter_names_abbreviated: ["1-ch", "2-ch", "3-ch", "4-ch"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["M.A.", "E"],
      era_names_abbreviated: ["M.A.", "E"],
      era_names_narrow: ["M.A.", "E"],
