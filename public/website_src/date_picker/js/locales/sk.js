  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Kliknite na alebo stlačte klávesu Enter alebo medzerník otvorte kalendár",
      ...
      day_names_abbreviated: ["ne", "po", "ut", "st", "št", "pi", "so"],
      day_names_short: ["Ne", "Po", "Ut", "St", "Št", "Pi", "So"],
      day_names_narrow: ["N", "P", "U", "S", "Š", "P", "S"],
      day_periods: {
        am: "dopoludnia",
        noon: "poludnie",
        pm: "odpoludnia",
      ...
      era_names: ["pred Kristom", "po Kristovi"],
      era_names_abbreviated: ["pred Kr.", "po Kr."],
      era_names_narrow: ["pred Kr.", "po Kr."],
