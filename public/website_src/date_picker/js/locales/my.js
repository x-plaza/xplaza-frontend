(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_narrow: ["တ", "တ", "အ", "ဗ", "က", "သ", "စ"],
      day_periods: {
        am: "နံနက်",
        noon: "မွန်းတည့်",
        pm: "ညနေ",
      ...
      quarter_names_narrow: ["ပ", "ဒု", "တ", "စ"],
      era_names: ["ခရစ်တော် မပေါ်မီကာလ", "ခရစ်တော် ပေါ်ထွန်းပြီးကာလ"],
      era_names_abbreviated: ["ဘီစီ", "အေဒီ"],
      era_names_narrow: ["ဘီစီ", "အေဒီ"],
