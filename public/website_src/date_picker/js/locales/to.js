(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_abbreviated: ["Sāp", "Mōn", "Tūs", "Pul", "Tuʻa", "Fal", "Tok"],
      day_names_short: ["Sāp", "Mōn", "Tūs", "Pul", "Tuʻa", "Fal", "Tok"],
      day_names_narrow: ["S", "M", "T", "P", "T", "F", "T"],
      day_periods: {
        am: "AM",
        noon: "hoʻatā",
        pm: "PM",
      ...
      quarter_names: ["kuata ʻuluaki", "kuata ua", "kuata tolu", "kuata fā"],
      quarter_names_abbreviated: ["K1", "K2", "K3", "K4"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["ki muʻa", "taʻu ʻo Sīsū"],
      era_names_abbreviated: ["KM", "TS"],
      era_names_narrow: ["KāMā", "TāSā"],
