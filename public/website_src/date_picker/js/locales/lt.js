  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Spauskite arba paspauskite klavišą Enter arba tarpo atidaryti kalendorių",
      ...
      day_names_abbreviated: ["sk", "pr", "an", "tr", "kt", "pn", "št"],
      day_names_short: ["Sk", "Pr", "An", "Tr", "Kt", "Pn", "Št"],
      day_names_narrow: ["S", "P", "A", "T", "K", "P", "Š"],
      day_periods: {
        am: "priešpiet",
        noon: "perpiet",
        pm: "popiet",
      ...
      quarter_names_abbreviated: ["I k.", "II k.", "III k.", "IV k."],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["prieš Kristų", "po Kristaus"],
      era_names_abbreviated: ["pr. Kr.", "po Kr."],
      era_names_narrow: ["pr. Kr.", "po Kr."],
