  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "I-click o pindutin ang Enter key o ang spacebar upang buksan ang kalendaryo",
      ...
      day_names_abbreviated: ["Lin", "Lun", "Mar", "Miy", "Huw", "Biy", "Sab"],
      day_names_short: ["Li", "Lu", "Ma", "Mi", "Hu", "Bi", "Sa"],
      day_names_narrow: ["L", "L", "M", "M", "H", "B", "S"],
      day_periods: {
        am: "AM",
        noon: "tanghali",
        pm: "PM",
