(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_abbreviated: ["Sv", "Pr", "Ot", "Tr", "Ce", "Pk", "Se"],
      day_names_short: ["Sv", "Pr", "Ot", "Tr", "Ce", "Pk", "Se"],
      day_names_narrow: ["S", "P", "O", "T", "C", "P", "S"],
      day_periods: {
        am: "priekšpusdienā",
        noon: "pusdienlaikā",
        pm: "pēcpusdienā",
      ...
      quarter_names_abbreviated: ["1. cet.", "2. cet.", "3. cet.", "4. cet."],
      quarter_names_narrow: ["1.", "2.", "3.", "4."],
      era_names: ["pirms mūsu ēras", "mūsu ērā"],
      era_names_abbreviated: ["p.m.ē.", "m.ē."],
      era_names_narrow: ["p.m.ē.", "m.ē."],
