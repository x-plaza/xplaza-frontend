  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Basın və ya Enter düyməsini basın və ya boşluq təqvim açmaq",
      ...
      day_names_abbreviated: ["B.", "B.E.", "Ç.A.", "Ç.", "C.A.", "C.", "Ş."],
      day_names_short: ["B.", "B.E.", "Ç.A.", "Ç.", "C.A.", "C.", "Ş."],
      day_names_narrow: ["7", "1", "2", "3", "4", "5", "6"],
      day_periods: {
        am: "AM",
        noon: "günorta",
        pm: "PM",
      ...
      era_names: ["eramızdan əvvəl", "bizim eramızın"],
      era_names_abbreviated: ["e.ə.", "b.e."],
      era_names_narrow: ["e.ə.", "b.e."],
