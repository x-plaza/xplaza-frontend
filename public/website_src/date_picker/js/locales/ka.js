  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "დაწკაპეთ და დააჭირეთ ღილაკს Enter და spacebar გახსნას კალენდარი",
      ...
      day_names_abbreviated: ["კვი", "ორშ", "სამ", "ოთხ", "ხუთ", "პარ", "შაბ"],
      day_names_short: ["კვ", "ორ", "სმ", "ოთ", "ხთ", "პრ", "შბ"],
      day_names_narrow: ["კ", "ო", "ს", "ო", "ხ", "პ", "შ"],
      day_periods: {
        am: "AM",
        noon: "შუადღე",
        pm: "PM",
      ...
      quarter_names_abbreviated: ["I კვ.", "II კვ.", "III კვ.", "IV კვ."],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["ძველი წელთაღრიცხვით", "ახალი წელთაღრიცხვით"],
      era_names_abbreviated: ["ძვ. წ.", "ახ. წ."],
      era_names_narrow: ["ძვ. წ.", "ახ. წ."],
