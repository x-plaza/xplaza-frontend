  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Click au vyombo vya habari Enter muhimu au spacebar kufungua kalenda",
      ...
      day_names_abbreviated: ["yen", "kwa", "pil", "tat", "ine", "tan", "sit"],
      day_names_short: [
        "Jumapili",
        "Jumatatu",
        "Jumanne",
      ...
      quarter_names: ["Robo ya 1", "Robo ya 2", "Robo ya 3", "Robo ya 4"],
      quarter_names_abbreviated: ["R1", "R2", "R3", "R4"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["Kabla ya Kristo", "Baada ya Kristo"],
