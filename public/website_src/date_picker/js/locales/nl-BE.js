  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klik of druk op de Enter-toets of de spatiebalk om de kalender te openen",
      ...
      day_names_abbreviated: ["zo", "ma", "di", "wo", "do", "vr", "za"],
      day_names_short: ["zo", "ma", "di", "wo", "do", "vr", "za"],
      day_names_narrow: ["Z", "M", "D", "W", "D", "V", "Z"],
      day_periods: {
        am: "a.m.",
      ...
      era_names: ["voor Christus", "na Christus"],
      era_names_abbreviated: ["v.Chr.", "n.Chr."],
      era_names_narrow: ["v.C.", "n.C."],
