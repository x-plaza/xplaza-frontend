  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Prema ou preme a tecla Intro ou a barra de espazo para abrir o calendario",
      ...
      day_names_abbreviated: ["dom", "lun", "mar", "mér", "xov", "ven", "sáb"],
      day_names_short: ["dom", "luns", "mt", "mc", "xv", "ve", "sáb"],
      day_names_narrow: ["D", "L", "M", "M", "X", "V", "S"],
      day_periods: {
        am: "a.m.",
        noon: "mediodía",
        pm: "p.m.",
      ...
      era_names: ["antes de Cristo", "despois de Cristo"],
