  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Kliknite ili pritisnite tipku Enter ili razmaknicu da biste otvorili kalendar",
      ...
      day_names_abbreviated: ["ned", "pon", "uto", "sri", "čet", "pet", "sub"],
      day_names_short: ["ned", "pon", "uto", "sri", "čet", "pet", "sub"],
      day_names_narrow: ["N", "P", "U", "S", "Č", "P", "S"],
      day_periods: {
        am: "AM",
        noon: "podne",
        pm: "PM",
      ...
      quarter_names_abbreviated: ["1kv", "2kv", "3kv", "4kv"],
      quarter_names_narrow: ["1.", "2.", "3.", "4."],
      era_names: ["Prije Krista", "Poslije Krista"],
      era_names_abbreviated: ["pr. Kr.", "p. Kr."],
      era_names_narrow: ["pr.n.e.", "AD"],
