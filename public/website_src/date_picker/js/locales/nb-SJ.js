  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klikk eller trykk på Enter-tasten eller mellomromstasten for å åpne kalender",
