  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klik atau tekan tombol Enter atau spasi untuk membuka kalender",
      ...
      day_names_abbreviated: ["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"],
      day_names_short: ["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"],
      day_names_narrow: ["M", "S", "S", "R", "K", "J", "S"],
      day_periods: {
        am: "AM",
        noon: "tengah hari",
        pm: "PM",
      ...
      era_names: ["Sebelum Masehi", "M"],
      era_names_abbreviated: ["SM", "M"],
      era_names_narrow: ["SM", "M"],
