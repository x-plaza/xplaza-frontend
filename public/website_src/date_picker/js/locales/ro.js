  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Faceți clic sau apăsați tasta Enter sau bara de spațiu pentru a deschide calendarul",
      ...
      day_names_abbreviated: ["Dum", "Lun", "Mar", "Mie", "Joi", "Vin", "Sâm"],
      day_names_short: ["Du", "Lu", "Ma", "Mi", "Jo", "Vi", "Sâ"],
      day_names_narrow: ["D", "L", "M", "M", "J", "V", "S"],
      day_periods: {
        am: "a.m.",
        noon: "la prânz",
        pm: "p.m.",
      ...
      era_names: ["înainte de Hristos", "după Hristos"],
      era_names_abbreviated: ["î.Hr.", "d.Hr."],
      era_names_narrow: ["î.Hr.", "d.Hr."],
