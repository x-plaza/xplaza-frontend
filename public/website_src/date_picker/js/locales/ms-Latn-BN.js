  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klik atau tekan kekunci Enter atau bar ruang untuk membuka kalendar",
      ...
      day_names_abbreviated: ["Ahd", "Isn", "Sel", "Rab", "Kha", "Jum", "Sab"],
      day_names_short: ["Ah", "Is", "Se", "Ra", "Kh", "Ju", "Sa"],
      day_names_narrow: ["A", "I", "S", "R", "K", "J", "S"],
      day_periods: {
        am: "PG",
        noon: "t/hari",
        pm: "PTG",
      ...
      quarter_names: ["Suku pertama", "Suku Ke-2", "Suku Ke-3", "Suku Ke-4"],
      quarter_names_abbreviated: ["S1", "S2", "S3", "S4"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["S.M.", "TM"],
      era_names_abbreviated: ["S.M.", "TM"],
      era_names_narrow: ["S.M.", "TM"],
