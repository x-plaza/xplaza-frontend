(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      quarter_names_abbreviated: ["K1", "K2", "K3", "K4"],
      quarter_names_narrow: ["1.", "2.", "3.", "4."],
      era_names: ["Prije nove ere", "Nove ere"],
      era_names_abbreviated: ["p. n. e.", "n. e."],
      era_names_narrow: ["p. n. e.", "n. e."],
