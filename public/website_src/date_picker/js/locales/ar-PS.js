  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "انقر أو اضغط على مفتاح Enter أو مفتاح المسافة لفتح التقويم",
      ...
      day_names_narrow: ["ح", "ن", "ث", "ر", "خ", "ج", "س"],
      day_periods: {
        am: "ص",
        noon: "ظهرا",
        pm: "م",
      ...
      quarter_names_narrow: ["١", "٢", "٣", "٤"],
      era_names: ["قبل الميلاد", "ميلادي"],
      era_names_abbreviated: ["ق.م", "م"],
      era_names_narrow: ["ق.م", "م"],
