(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_narrow: ["Ж", "Д", "Ш", "Ш", "Б", "Ж", "И"],
      day_periods: {
        am: "таңкы",
        noon: "чак түш",
        pm: "түштөн кийин",
      ...
      quarter_names: ["1-чейрек", "2-чейрек", "3-чейрек", "4-чейрек"],
      quarter_names_abbreviated: ["1-чей.", "2-чей.", "3-чей.", "4-чей."],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["биздин заманга чейин", "биздин заман"],
      era_names_abbreviated: ["б.з.ч.", "б.з."],
      era_names_narrow: ["б.з.ч.", "б.з."],
