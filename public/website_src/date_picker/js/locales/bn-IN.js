  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "দেখার জন্য ক্লিক করুন অথবা Enter কী চাপুন বা spacebar ক্যালেন্ডার খুলুন",
      ...
      day_names_short: ["রঃ", "সোঃ", "মঃ", "বুঃ", "বৃঃ", "শুঃ", "শোঃ"],
      day_names_narrow: ["র", "সো", "ম", "বু", "বৃ", "শু", "শ"],
      day_periods: {
        am: "পূর্বাহ্ণ",
        noon: "দুপুর",
        pm: "অপরাহ্ণ",
      ...
      quarter_names_narrow: ["১", "২", "৩", "৪"],
      era_names: ["খ্রিস্টপূর্ব", "খৃষ্টাব্দ"],
      era_names_abbreviated: ["খ্রিস্টপূর্ব", "খৃষ্টাব্দ"],
      era_names_narrow: ["খ্রিস্টপূর্ব", "খৃষ্টাব্দ"],
