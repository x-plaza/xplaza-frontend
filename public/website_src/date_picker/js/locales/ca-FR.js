  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Feu clic o premeu la tecla Retorn o la barra d'espai per obrir el calendari",
      ...
      day_names_abbreviated: ["dg.", "dl.", "dt.", "dc.", "dj.", "dv.", "ds."],
      day_names_short: ["dg.", "dl.", "dt.", "dc.", "dj.", "dv.", "ds."],
      day_names_narrow: ["dg", "dl", "dt", "dc", "dj", "dv", "ds"],
      day_periods: {
        am: "a. m.",
        noon: "migdia",
        pm: "p. m.",
      ...
      quarter_names_abbreviated: ["1T", "2T", "3T", "4T"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["abans de Crist", "després de Crist"],
