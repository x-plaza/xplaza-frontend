  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Klepněte na nebo stiskněte klávesu Enter nebo mezerník otevřete kalendář",
      ...
      day_names_abbreviated: ["ne", "po", "út", "st", "čt", "pá", "so"],
      day_names_short: ["ne", "po", "út", "st", "čt", "pá", "so"],
      day_names_narrow: ["N", "P", "Ú", "S", "Č", "P", "S"],
      day_periods: {
        am: "dopoledne",
        noon: "poledne",
        pm: "odpoledne",
      ...
      era_names_abbreviated: ["př. n. l.", "n. l."],
      era_names_narrow: ["př.n.l.", "n.l."],
