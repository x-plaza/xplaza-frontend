  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Click or Enter tuşuna basın veya boşluk takvimi açmak için",
      ...
      day_names_abbreviated: ["Paz", "Pzt", "Sal", "Çar", "Per", "Cum", "Cmt"],
      day_names_short: ["Pa", "Pt", "Sa", "Ça", "Pe", "Cu", "Ct"],
      day_names_narrow: ["P", "P", "S", "Ç", "P", "C", "C"],
      day_periods: {
        am: "ÖÖ",
        noon: "öğle",
        pm: "ÖS",
      ...
      quarter_names: ["1. çeyrek", "2. çeyrek", "3. çeyrek", "4. çeyrek"],
      quarter_names_abbreviated: ["Ç1", "Ç2", "Ç3", "Ç4"],
      quarter_names_narrow: ["1.", "2.", "3.", "4."],
      era_names: ["Milattan Önce", "Milattan Sonra"],
      era_names_abbreviated: ["MÖ", "MS"],
      era_names_narrow: ["MÖ", "MS"],
