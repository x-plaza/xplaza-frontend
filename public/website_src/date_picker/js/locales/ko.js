  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        buttonTitle: "날짜 선택 ...",
        buttonLabel:
          "클릭하거나 Enter 키를 누르거나 스페이스 바를 달력을 엽니 다",
      ...
      day_names_abbreviated: ["일", "월", "화", "수", "목", "금", "토"],
      day_names_short: ["일", "월", "화", "수", "목", "금", "토"],
      day_names_narrow: ["일", "월", "화", "수", "목", "금", "토"],
      day_periods: {
        am: "오전",
        noon: "정오",
        pm: "오후",
      ...
      quarter_names: ["제 1/4분기", "제 2/4분기", "제 3/4분기", "제 4/4분기"],
      quarter_names_abbreviated: ["1분기", "2분기", "3분기", "4분기"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["기원전", "서기"],
      era_names_abbreviated: ["기원전", "서기"],
      era_names_narrow: ["기원전", "서기"],
