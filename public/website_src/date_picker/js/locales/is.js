  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Smellur eða ýttu á Enter takkann eða rúm til að opna dagbókina",
      ...
      day_names_short: ["su.", "má.", "þr.", "mi.", "fi.", "fö.", "la."],
      day_names_narrow: ["S", "M", "Þ", "M", "F", "F", "L"],
      day_periods: {
        am: "f.h.",
        noon: "hádegi",
        pm: "e.h.",
      ...
      quarter_names_abbreviated: ["F1", "F2", "F3", "F4"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["fyrir Krist", "eftir Krist"],
      era_names_abbreviated: ["f.Kr.", "e.Kr."],
      era_names_narrow: ["f.k.", "e.k."],
