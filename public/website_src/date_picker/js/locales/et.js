(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_abbreviated: ["P", "E", "T", "K", "N", "R", "L"],
      day_names_short: ["P", "E", "T", "K", "N", "R", "L"],
      day_names_narrow: ["P", "E", "T", "K", "N", "R", "L"],
      day_periods: {
        am: "AM",
        noon: "keskpäev",
        pm: "PM",
      ...
      era_names: ["enne meie aega", "meie aja järgi"],
      era_names_abbreviated: ["e.m.a.", "m.a.j."],
      era_names_narrow: ["e.m.a.", "m.a.j."],
