  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Egin klik edo sakatu Sartu tekla edo zuriune egutegi irekitzeko",
      ...
      day_names_abbreviated: ["ig.", "al.", "ar.", "az.", "og.", "or.", "lr."],
      day_names_short: ["ig.", "al.", "ar.", "az.", "og.", "or.", "lr."],
      day_names_narrow: ["I", "A", "A", "A", "O", "O", "L"],
      day_periods: {
        am: "AM",
        noon: "eguerdia",
        pm: "PM",
      ...
      quarter_names_abbreviated: ["1Hh", "2Hh", "3Hh", "4Hh"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["K.a.", "K.o."],
      era_names_abbreviated: ["K.a.", "K.o."],
      era_names_narrow: ["K.a.", "K.o."],
