(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names: ["እሑድ", "ሰኞ", "ማክሰኞ", "ረቡዕ", "ሐሙስ", "ዓርብ", "ቅዳሜ"],
      day_names_abbreviated: ["እሑድ", "ሰኞ", "ማክሰ", "ረቡዕ", "ሐሙስ", "ዓርብ", "ቅዳሜ"],
      day_names_short: ["እ", "ሰ", "ማ", "ረ", "ሐ", "ዓ", "ቅ"],
      day_names_narrow: ["እ", "ሰ", "ማ", "ረ", "ሐ", "ዓ", "ቅ"],
      day_periods: {
        am: "ጥዋት",
        noon: "ቀትር",
        pm: "ከሰዓት",
      ...
      quarter_names: ["1ኛው ሩብ", "ሁለተኛው ሩብ", "3ኛው ሩብ", "4ኛው ሩብ"],
      quarter_names_abbreviated: ["ሩብ1", "ሩብ2", "ሩብ3", "ሩብ4"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["ዓመተ ዓለም", "ዓመተ ምሕረት"],
      era_names_abbreviated: ["ዓ/ዓ", "ዓ/ም"],
      era_names_narrow: ["ዓ/ዓ", "ዓ/ም"],
