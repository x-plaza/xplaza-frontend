  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      texts: {
        ...
        buttonLabel:
          "Nhấn vào đây hoặc bấm phím Enter hoặc phím cách để mở lịch",
      ...
      day_names_narrow: ["CN", "T2", "T3", "T4", "T5", "T6", "T7"],
      day_periods: {
        am: "SA",
        noon: "TR",
        pm: "CH",
      ...
      era_names: ["tr. CN", "sau CN"],
      era_names_abbreviated: ["tr. CN", "sau CN"],
      era_names_narrow: ["tr. CN", "sau CN"],
