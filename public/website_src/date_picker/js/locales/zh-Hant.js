(function () {
  ...
  if (typeof Date.dp_locales === "undefined") {
    Date.dp_locales = {
      ...
      day_names_narrow: ["日", "一", "二", "三", "四", "五", "六"],
      day_periods: {
        afternoon: "下午",
        am: "上午",
        earlyMorning: "清晨",
      ...
      quarter_names: ["第1季", "第2季", "第3季", "第4季"],
      quarter_names_abbreviated: ["1季", "2季", "3季", "4季"],
      quarter_names_narrow: ["1", "2", "3", "4"],
      era_names: ["西元前", "西元"],
      era_names_abbreviated: ["西元前", "西元"],
      era_names_narrow: ["西元前", "西元"],
      full_format: "y年M月d日 EEEE",
      long_format: "y年M月d日",
