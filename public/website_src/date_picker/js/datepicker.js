...
(function (factory) {
  ...
  var Datepicker = function (target, options) {
    ...
    var calendar =
      this.options.markup == "bootstrap3"
        ? datepickerCalendar3.join("")
        : datepickerCalendar4.join("");
    ...
    var button =
      this.options.markup == "bootstrap3"
        ? datepickerButton3.join("")
        : datepickerButton4.join("");
  ...
  Datepicker.prototype.showDaysOfNextMonth = function (offset) {
    ...
    if (offset != null) {
      ...
      while (
        offset < $allCells.length &&
        !$allCells.eq(offset).hasClass("selectable")
      ) {
        offset++;
      }
  ...
  Datepicker.prototype.handleGridKeyDown = function (e) {
    ...
    switch (e.keyCode) {
      ...
      case this.keys.up: {
        ...
        while (
          cellIndex >= 0 &&
          !$allCells.eq(cellIndex).hasClass("selectable")
        ) {
          cellIndex--;
        }
        if (cellIndex >= 0) {
  ...
  Datepicker.prototype.show = function () {
    ...
    var groupOffsetLeft = Math.max(
      0,
      Math.floor(this.$group[0].offsetLeft + this.$target[0].offsetLeft),
    );
    ...
    var roomAfter = Math.floor(
      $(window).height() -
        (groupAbsoluteTop + groupHeight - $(window).scrollTop()),
    );
