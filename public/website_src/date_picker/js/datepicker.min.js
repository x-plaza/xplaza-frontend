  ...
  (function (n) {
    ...
    var u = [
      ...
      i = function (t, r) {
        ...
        typeof this.options.inputFormat == "string" &&
          (this.options.inputFormat = [this.options.inputFormat]);
        Array.isArray(this.options.datesDisabled) ||
        ...
        n.each(this.options.datesDisabled, function (n, t) {
          if (typeof t == "string") {
            ...
            s.options.datesDisabled[n] =
              t instanceof Date && !isNaN(t.valueOf()) ? s.format(t) : null;
        });
        ...
        this.options.buttonLeft
          ? this.$target.before(this.$button)
          : this.$target.after(this.$button);
        this.$calendar.parent().css("position") === "static" &&
        ...
        this.$button.on("click", function (t) {
          return (
            n(this).hasClass("disabled") ||
              (s.$calendar.attr("aria-hidden") === "true"
                ? (s.initializeDate(), s.show())
                : s.hide(),
        ...
        this.$button.on("keydown", function (t) {
          var i = t || event;
          if (i.keyCode == s.keys.enter || i.keyCode == s.keys.space)
            return n(this).trigger("click"), !1;
        });
    ...
    i.prototype.drawCalendarHeader = function () {
      for (
        var i = this.$grid.find("th.datepicker-day"),
          n = this.options.firstDayOfWeek,
          t = 0;
        t < 7;
        t++
      )
    ...
    i.prototype.populateDaysCalendar = function () {
      ...
      (f.year < this.options.min.getFullYear() ||
        (f.year == this.options.min.getFullYear() &&
          f.month < this.options.min.getMonth()))
      ...
      (s.year > this.options.max.getFullYear() ||
        (s.year == this.options.max.getFullYear() &&
          s.month > this.options.max.getMonth()))
      ...
      for (
        var i = '\t<tr id="row0-' + this.id + '" role="row">\n',
          e = 0,
          r = this.options.firstDayOfWeek;
        r != b;

      )
        e++, (r = (r + 1) % 7);
      for (; e > 0; e--)
        i += '\t\t<td class="empty">' + (w - e + 1) + "<\/td>\n";
      for (
        v =
    ...
    i.prototype.populateMonthsCalendar = function () {
      ...
      for (
        ...
        (i += f
            ...
            : this.options.min != null &&
              ...
              : this.options.max != null &&
                ...
                ? '\t\t<td id="cell' +
                  ...
                  '" class="month unselectable"'
                : this.options.isMonthDisabled &&
                    this.options.isMonthDisabled(this.year, t + 1)
                  ? '\t\t<td id="cell' +
                    (t + 1) +
                    "-" +
                    this.id +
          ...
          (i += ' data-value="' + t + '"'),
          (i +=
            ' title="' + this.locales.month_names[t] + " " + this.year + '"'),
          (i +=
            ' aria-label="' +
    ...
    i.prototype.showDaysOfPrevMonth = function (n) {
      ...
      if (
        ...
        for (
          i = this.$grid.find("td"), n = i.length - n;
          n >= 0 && !i.eq(n).hasClass("selectable");

        )
          n--;
        n >= 0 &&
          ((r = i.eq(n).attr("id")),
          this.$grid.attr("aria-activedescendant", r),
    ...
    i.prototype.showDaysOfMonth = function (n) {
      if (
        (this.options.min != null &&
          (this.year < this.options.min.getFullYear() ||
            (this.year == this.options.min.getFullYear() &&
              n < this.options.min.getMonth()))) ||
        (this.options.max != null &&
          (this.year > this.options.max.getFullYear() ||
            (this.year == this.options.max.getFullYear() &&
              n > this.options.max.getMonth())))
      )
        return !1;
      this.month = n;
      this.date = Math.min(
    ...
    i.prototype.showMonthsOfPrevYear = function (n) {
      ...
      if ((this.year--, this.populateMonthsCalendar(), n != null)) {
        for (
          t = this.$grid.find("td"), n = t.length - n;
          n >= 0 && !t.eq(n).hasClass("selectable");

        )
          n--;
        n >= 0 &&
          ((i = t.eq(n).attr("id")),
          this.$grid.attr("aria-activedescendant", i),
          this.selectGridCell(i));
      }
      return !0;
    };
    i.prototype.showMonthsOfYear = function (n) {
      ...
      return (
        this.$grid.attr("aria-activedescendant", t.attr("id")),
        this.selectGridCell(t.attr("id")),
        !0
      );
    };
    ...
    i.prototype.showDaysOfNextMonth = function (n) {
      ...
      if (
        ...
        for (
          i = this.$grid.find("td"), n--;
          n < i.length && !i.eq(n).hasClass("selectable");
    ...
    i.prototype.showMonthsOfNextYear = function (n) {
      ...
      if ((this.year++, this.populateMonthsCalendar(), n != null)) {
        for (
          t = this.$grid.find("td"), n--;
          n < t.length && !t.eq(n).hasClass("selectable");
    ...
    i.prototype.handleFastPrevKeyDown = function (n) {
      ...
      switch (n.keyCode) {
        ...
        case this.keys.space:
          return n.shiftKey || n.ctrlKey
            ? !0
            : (this.showDaysOfPrevYear(), n.stopPropagation(), !1);
        case this.keys.esc:
          return this.hide(), n.stopPropagation(), !1;
      }
      return !0;
    ...
    i.prototype.handleGridKeyDown = function (i) {
      var u = n("#" + this.$grid.attr("aria-activedescendant")),
        ...
        a = this.$grid.find("tbody tr").eq(0).find("td").length,
        h,
        o,
        r,
        c,
      ...
      if (
        i.altKey &&
        i.keyCode != this.keys.pageup &&
        i.keyCode != this.keys.pagedown
      )
        return !0;
      switch (i.keyCode) {
        case this.keys.tab:
        ...
        case this.keys.right:
          if (
            (i.keyCode == this.keys.left &&
              this.locales.directionality === "LTR") ||
            (i.keyCode == this.keys.right &&
        ...
        case this.keys.up:
          if (i.ctrlKey || i.shiftKey) return !0;
          for (
            var o = this.$grid.find("td"), r = o.index(u) - a, h = null;
            r >= 0 && !o.eq(r).hasClass("selectable");
        ...
        case this.keys.down:
          if (i.ctrlKey || i.shiftKey) return !0;
          for (
            o = this.$grid.find("td"), r = o.index(u) + a;
            r < o.length && !o.eq(r).hasClass("selectable");
        ...
        case this.keys.pageup:
          if (
            ((l = this.$grid.attr("aria-activedescendant")),
    ...
    i.prototype.handleTabOut = function (t) {
      ...
      return (
        i > -1 &&
          i < r.length &&
          (t.shiftKey ? i > 0 && i-- : i + 1 < r.length && i++,
          r.eq(i).focus()),
        !0
      );
    };
        ...
        case 0:
          ...
          this.year != this.curYear
            ? ((t = this.$grid.find("td.selectable")),
              this.$grid.attr("aria-activedescendant", t.eq(0).attr("id")))
            : this.$grid.attr(
                "aria-activedescendant",
                this.$grid.find(".curMonth").attr("id"),
              );
    ...
    i.prototype.show = function () {
      var t = this,
        i;
      if (
        (n(".datepicker-calendar").trigger("ab.datepicker.opening", [t.id]),
      ...
      s < f && s < h
        ? (this.$calendar.addClass("above"),
          this.$calendar.css({ top: r - f + "px", left: u + "px" }))
        : (this.$calendar.addClass("below"),
          this.$calendar.css({ top: r + o + "px", left: u + "px" }));
      ...
      if (this.options.inline == !1) {
        ...
        this.options.modal == !0
          ? (this.modalEventHandler &&
            ...
            this.greyOut(!1))
          : (n(document).off("click", i.handleDocumentClick),
      ...
      var o = function (n, t, i, r) {
        ...
        v = function (n, t) {
          for (var u, r = 0; r < n.length; r++)
            if (
              ((u = n[r]),
              i.substring(t, t + u.length).toLowerCase() == u.toLowerCase())
            )
              return u.length;
          return 0;
        },
        ...
        (n.each(t.match(/(.).*?\1*/g), function (n, t) {
          ...
          switch (t) {
            ...
            case "LLL":
              for (
                e = 0, y = 0;
                y < s.locales.month_names_abbreviated.length;
                y++
              )
                if (
            ...
            case "LL":
            case "L":
              if (((e = o(i, r, t.length, 2)), e == null || e < 1 || e > 12))
                return null;
              r += e.length;
              break;
            case "dd":
            case "d":
              if (((h = o(i, r, t.length, 2)), h == null || h < 1 || h > 31))
                return null;
              r += h.length;
              break;
            case "hh":
            case "h":
              if (((u = o(i, r, t.length, 2)), u == null || u < 1 || u > 12))
                return null;
              r += u.length;
              break;
            case "HH":
            case "H":
              if (((u = o(i, r, t.length, 2)), u == null || u < 0 || u > 23))
                return null;
              r += u.length;
              break;
            case "KK":
            case "K":
              if (((u = o(i, r, t.length, 2)), u == null || u < 0 || u > 11))
                return null;
              r += u.length;
              break;
            case "kk":
            case "k":
              if (((u = o(i, r, t.length, 2)), u == null || u < 1 || u > 24))
                return null;
              r += u.length;
              u--;
              break;
            case "mm":
            case "m":
              if (((c = o(i, r, t.length, 2)), c == null || c < 0 || c > 59))
                return null;
              r += c.length;
              break;
            case "ss":
            case "s":
              if (((l = o(i, r, t.length, 2)), l == null || l < 0 || l > 59))
                return null;
              r += l.length;
              break;
            case "a":
              if (
                ...
                (a = "AM"), (r += w);
              else if (i.substring(r, r + b) == s.locales.day_periods.pm)
                (a = "PM"), (r += b);
              else return null;
              break;
            default:
      ...
      return (
        t != null &&
          (typeof t == "string"
            ...
            : this.options.next instanceof jQuery && (this.options.next = t)),
        this.options.next
      );
    };
      ...
      if (t != null) {
        ...
        n.each(t, function (n, t) {
          typeof t == "number"
            ...
            : typeof t == "string" &&
              i.options.daysOfWeekDisabled.push(parseInt(t, 10));
        });
      }
    ...
    i.prototype.weekDayFormat = function (n) {
      return (
        n != null &&
          ((this.options.weekDayFormat = n), this.drawCalendarHeader()),
    ...
    i.prototype.inputFormat = function (n) {
      return (
        n != null &&
          (Array.isArray(n) || (n = [n]),
          this.$target.attr("placeholder") == this.options.inputFormat[0] &&
            this.$target.attr("placeholder", n[0]),
    ...
    i.prototype.outputFormat = function (n) {
      return (
        n != null && (this.options.outputFormat = n), this.options.outputFormat
      );
    };
    ...
    n.fn.datepicker = function (t, r) {
      ...
      if (typeof t == "string" && n(this).length == 1) {
        if (((u = n(this).eq(0).data("ab.datepicker")), u)) return u[t](r);
        f = n(this);
        setTimeout(function () {
