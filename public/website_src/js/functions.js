(function ($) {
  ...
  $(".info-hover-effect-parent").on(
    "mouseover",
    ".info-hover-effect-child",
    function () {
  ...
  $(".price-increase-decrese-group .quantity-right-plus").on(
    "click",
    function () {
      var $qty = $(this)
        .closest(".price-increase-decrese-group")
        .find(".input-number");
  ...
  $(".price-increase-decrese-group .quantity-left-minus").on(
    "click",
    function () {
      var ths = $(this);
      var $qty = $(this)
  ...
  $(window).on("scroll", function () {
    ...
    if (scroll >= 100) {
      $(".header-bottom,.mobile-header,.catagory-sidebar-area").addClass(
        "fixed-totop animated slideInDown",
      );
    } else {
      $(".header-bottom,.mobile-header,.catagory-sidebar-area").removeClass(
        "fixed-totop  animated slideInDown",
      );
    }
  });
...
function closeModal() {
  document
    .getElementById("product-details-popup")
    .classList.remove("open-side");
}
