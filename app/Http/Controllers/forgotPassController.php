...
class forgotPassController extends Controller
{
    ...
    public function setForgotPass(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL')."/api/customer-login/validate-otp?OTP=".$otp_code."&username=".urlencode($user_name);
        $curlOutput  = HandleApi::getCURLOutput( $api_url, 'POST', [] );
        $decodedResp = json_decode($curlOutput);
        ...
        $change_pass_api_url = env('API_BASE_URL')."/api/customer-login/change-password?newPassword=".$new_password."&username=".urlencode($user_name);
        $change_pass_curlOutput  = HandleApi::getCURLOutput( $change_pass_api_url, 'POST', [] );
