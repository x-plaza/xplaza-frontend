...
class dashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $api_url = env('API_BASE_URL').'/shops?user_id=8';
        $curlOutput = HandleApi::getCURLOutput($api_url, 'GET', []);
        $decodedData = json_decode($curlOutput);
    ...
    public function myOrderList(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL').'/orders/by-customer?customer_id='.intval($auth_user_id);
        $curlOutput = HandleApi::getCURLOutput($api_url, 'GET', []);
        $decodedData = json_decode($curlOutput);
    ...
    public function myProfile(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL').'/customers/'.intval($auth_user_id);
        $curlOutput = HandleApi::getCURLOutput($api_url, 'GET', []);
        $decodedData = json_decode($curlOutput);
    ...
    public function updateProfile(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL').'/customers';
